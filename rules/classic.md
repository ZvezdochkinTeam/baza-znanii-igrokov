...
При обнаружении игрока [противоположного вам нейтрального класса](#user-content-fn-3)[^3] с [оружием в руках](#user-content-fn-4)[^4] и/или при поднятии им оружия на ваших глазах он становится для вас врагом, пока он не выбросит оружие и не прекратит сопротивление
{% endhint %}
...
3. В конце раунда разрешено воспроизводить посторонние звуки, но не громкие и неприятные
{% endhint %}
...
{% hint style="success" %}
**Исключения к** [**личным оскорблениям**](#user-content-fn-7)[^7]
...
### C11. [Рейдерские атаки](#user-content-fn-8)[^8] и стороннее ПО
...
**Ответ:** C4 (Сотрудник Д-Класса не обязан выполнять [неадекватный приказ](#user-content-fn-11)[^11])
{% endhint %}
...
[^1]: Под этим подразумевается намеренная и безосновательная сдача самого себя в плен вражескому классу\
    \
    Пример: \
    Отряд МОГовцев сдался одному сотруднику Д-Класса возле Escape-Зоны, тем самым сменив свой класс на Повстанцев Хаоса
...
[^6]: **Глобальные голосовые каналы:**
    ...
    6. Рация
    7. Общий голосовой канал между Фламинго

[^7]: Оскорбление конкретного игрока
...
[^11]: **Признаки адекватного приказа:**
