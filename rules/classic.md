...
1. Закрытие дверей перед союзниками и суицид разрешены только при угрозе жизни\
...
4. В конце раунда это правило не действует&#x20;
{% endhint %}
...
1. Ивент-Мастера могут на своих ивентах разрешать игрокам транслировать посторонние звуки
...
**Ответ:** C4 (Сотрудник Д-Класса не обязан выполнять [неадекватный приказ](#user-content-fn-12)[^12])
{% endhint %}
...
[^3]: То есть сотрудник Д-Класса не становится врагом для других сотрудников Д-Класса, но становится врагом для МОГ, СБ и вооруженных научных сотрудников
...
[^12]: **Признаки адекватного приказа:**
