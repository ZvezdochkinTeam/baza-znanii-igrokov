...
### C4. Запрещено убивать связанного врага, безоружного врага в сопровождении человека[^1] противоположной ему команды и игрока нейтрального класса без веской на то причины

{% hint style="info" %}
**Примечания**

1. Убийство связанного врага, безоружного врага в сопровождении человека[^2] противоположной ему команды и игрока нейтрального класса разрешено только в случае:
   * Побега / попытки побега
   * Сопротивления
   * Неподчинения приказам[^3]
2. СБ/МОГ вправе связать столько сотрудников Д-Класса, сколько он захочет
{% endhint %}

{% hint style="info" %}
**Примеры нарушений**

1. Убийство связанного сотрудника Д-Класса в сопровождении научного сотрудника
2. Убийство безоружного бойца МОГ в сопровождении бойца ПХ
3. Убийство безоружного научного сотрудника сразу после того, как вы его заметили
{% endhint %}

{% hint style="success" %}
**Исключение**

Игрок нейтрального класса с [оружием в руках](#user-content-fn-4)[^4] становится врагом для остальных игроков [противоположного ему нейтрального класса](#user-content-fn-5)[^5]. Игроки [противоположного ему нейтрального класса](#user-content-fn-6)[^6] могут наносить урон по нему или убить его без предупреждения. Кооперация игроков  [противоположного ему нейтрального класса](#user-content-fn-7)[^7] с ним будет запрещена.
{% endhint %}

{% hint style="danger" %}
**Наказание**

+1 час за каждого убитого без причины

За 5 и более таких убийств: 15 дней -> 2 месяца
{% endhint %}
...
Нарушитель совершил ТК/МТК/ДК/МДК/УК/убийство связанного игрока противоположной команды -> Наказание удваивается\
\
...
### A11. Разборки с игроком проводятся в [админ. башне](#user-content-fn-8)[^8], а разборки с SCP в КС SCP-049, за Чумного Доктора
...
Вызвать МОГ могут только бойцы МОГ/СБ/НС

Вызвать ПХ могут только бойцы ПХ и сотрудники Д-Класса
...
### 4. МТК при спавне МОГ/ПХ

Если в течение 1 минуты после спавна МОГ/ПХ происходит МТК и остается 3 или меньше игроков (не считая нарушителя), то администрация может переспавнить МОГ/ПХ
...
[^1]: Именно человеческие классы, а не SCP

[^2]: Именно человеческие классы, а не SCP

[^3]: Невыполнимым и неадекватным приказам можно не подчиняться
...
[^5]: То есть сотрудник Д-Класса не становится врагом для других сотрудников Д-Класса, но становится врагом для научных сотрудников, МОГ и т.д

[^6]: То есть сотрудник Д-Класса не становится врагом для других сотрудников Д-Класса, но становится врагом для научных сотрудников, МОГ и т.д

[^7]: То есть сотрудник Д-Класса не становится врагом для других сотрудников Д-Класса, но становится врагом для научных сотрудников, МОГ и т.д

[^8]: Место появления роли Обучение
