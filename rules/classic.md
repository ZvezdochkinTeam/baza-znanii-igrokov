...
2\. СБ[^4]/МОГ[^5] вправе связать столько сотрудников Д-Класса, сколько он захочет
{% endhint %}
...
МОГ[^6]/СБ[^7]/НС[^8] могут стрелять по нему без предупреждения, кооперация с ним будет запрещена
...
+1 час за каждого убитого связанного/безоружного сотрудника Д-Класса/НС[^9]/МОГ[^10]/ПХ[^11]/СБ[^12] находящегося в сопровождении

15 дней за 5 и более убийств сотрудников Д-Класса без причины (Массовое убийство сотрудников Д-Класса) -> 2 месяца (За 2+ МДК[^13])
{% endhint %}
...
Нарушитель совершил ТК[^14]/МТК[^15]/ДК[^16]/МДК[^17]/УК[^18]/убийство связанного игрока противоположной команды -> Наказание удваивается\
\
...
### A11. Разборки с игроком проводятся в [админ. башне](#user-content-fn-19)[^19], а разборки с SCP в КС SCP-049, за Чумного Доктора
...
Игроки могут вызывать подкрепления через "Интерком" неограниченное количество раз за раунд

Вызвать МОГ[^20] могут только бойцы МОГ[^21]/СБ[^22]/НС[^23]

Вызвать ПХ[^24] могут только бойцы ПХ[^25] и сотрудники Д-Класса
...
### 4. МТК[^26] при спавне МОГ[^27]/ПХ[^28]

Если в течение 1 минуты после спавна МОГ[^29]/ПХ[^30] происходит МТК[^31] и остается 3 или меньше игроков (не считая нарушителя), то администрация может переспавнить МОГ[^32]/ПХ[^33]
...
[^4]: **СБ** - служба безопасности / охрана комплекса

[^5]: **МОГ -** Мобильная Оперативная Группа

[^6]: **МОГ -** Мобильная Оперативная Группа

[^7]: **СБ** - служба безопасности / охрана комплекса

[^8]: **НС** - научный сотрудник / учёный

[^9]: **НС** - научный сотрудник / учёный

[^10]: **МОГ -** Мобильная Оперативная Группа

[^11]: **ПХ** - повстанцы хаоса

[^12]: **СБ** - служба безопасности / охрана комплекса

[^13]: **МДК** - Массовое убийство сотрудников Д-Класса (Используется при выдачи блокировки за массовое убийство сотрудников Д-Класса без причины по правилу C4)

[^14]: **TK** - Тим килл / Убийство союзника (Используется при выдачи блокировки за убийство союзников по правилу C5)

[^15]: **МТК** - Массовый тим килл / Массовое убийство союзников (Используется при выдачи блокировки за массовое убийство союзников по правилу C5)

[^16]: **ДК** - Д килл / Убийство сотрудника Д-Класса (Используется при выдачи блокировки за убийство сотрудника Д-Класса без причины по правилу C4)

[^17]: **МДК** - Массовое убийство сотрудников Д-Класса (Используется при выдачи блокировки за массовое убийство сотрудников Д-Класса без причины по правилу C4)

[^18]: **УК** - Убийство учёного / Убийство научного сотрудника (Используется при выдачи блокировки за убийство научного сотрудника без причины по правилу C4 исключение)

[^19]: Место появления роли Обучение

[^20]: **МОГ -** Мобильная Оперативная Группа

[^21]: **МОГ -** Мобильная Оперативная Группа

[^22]: **СБ** - служба безопасности / охрана комплекса

[^23]: **НС** - научный сотрудник / учёный

[^24]: **ПХ** - повстанцы хаоса

[^25]: **ПХ** - повстанцы хаоса

[^26]: **МТК** - Массовый тим килл / Массовое убийство союзников (Используется при выдачи блокировки за массовое убийство союзников по правилу C5)

[^27]: **МОГ -** Мобильная Оперативная Группа

[^28]: **ПХ** - повстанцы хаоса

[^29]: **МОГ -** Мобильная Оперативная Группа

[^30]: **ПХ** - повстанцы хаоса

[^31]: **МТК** - Массовый тим килл / Массовое убийство союзников (Используется при выдачи блокировки за массовое убийство союзников по правилу C5)

[^32]: **МОГ -** Мобильная Оперативная Группа

[^33]: **ПХ** - повстанцы хаоса
