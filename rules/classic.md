...
1. "Скромник" (SCP-096) может кемпить[^3] 3 минуты
2. "Старый ИИ" (SCP-079) может кемпить[^4]
3. SCP можно кемпить[^5] на Gate-A и Gate-B
4. SCP можно кемпить[^6] Комнату Боеголовки в ЗТС (только для 14.0)
{% endhint %}
...
Запрещено намеренно наносить урон или убивать связанного врага, безоружного врага в сопровождении человека[^7] противоположной ему команды и игрока нейтрального класса без веской на то причины

{% hint style="info" %}
**Примечание**

Намеренное нанесение урона или убийство связанного врага, безоружного врага в сопровождении человека[^8] противоположной ему команды и игрока нейтрального класса разрешено только в случае:

* Побега / попытки побега после приказа
* Сопротивления
* Неподчинения [адекватным приказам](#user-content-fn-9)[^9]
{% endhint %}
...
При обнаружении игрока [противоположного вам нейтрального класса](#user-content-fn-10)[^10] с [оружием в руках](#user-content-fn-11)[^11] и/или при поднятии им оружия на ваших глазах он становится для вас врагом[^12], пока он не выбросит оружие и не прекратит сопротивление
{% endhint %}
...
Запрещено транслировать через микрофон [посторонние звуки](#user-content-fn-13)[^13] в [глобальные голосовые каналы](#user-content-fn-14)[^14].
...
{% hint style="success" %}
**Исключения к** [**личным оскорблениям**](#user-content-fn-15)[^15]
...
3. Лёгкие оскорбления не будут являться нарушением правил
4. Оскорбление встроенными репликами сервера не является нарушением
5. Оскорбления рода: Дурак, идиот, козёл и т.д. - не будут являться оскорблением
{% endhint %}
...
### C11. [Рейдерские атаки](#user-content-fn-16)[^16] и стороннее ПО

Запрещено проводить [рейдерские атаки](#user-content-fn-17)[^17] и использовать сторонние программы, дающие серьезное преимущество перед другими игроками.
...
Использование читов и [ограничителей пропускной способности](#user-content-fn-18)[^18], многократное нарушение правил, злоупотребление эксплойтами и багами игры, DoS - DDoS-атаки, стресс-тестеры, организованное нарушение правил, подстрекательство, попытка нарушить работоспособность сервера и т.п.
{% endhint %}
...
**Ответ:** C4 (Сотрудник Д-Класса не обязан выполнять [неадекватный приказ](#user-content-fn-19)[^19])
{% endhint %}
...
Нарушитель совершил ТК[^20] -> Наказание удваивается\
\
...
[^8]: Именно человеческие классы, а не SCP

[^9]: **Признаки адекватного приказа:**
...
[^11]: Да, именно **В РУКАХ**, а не в инвентаре
...
[^12]: Враг = враждебный класс

[^13]: Soundpad, телефон у микрофона :) и другие средства воспроизведения сторонних звуков

[^14]: **Глобальные голосовые каналы:**
...
[^15]: Оскорбление конкретного игрока

[^16]: **Рейдерская атака** - это намеренное нарушение правил сервера\
    \
    **Пример:** Намеренное убийство союзников

[^17]: **Рейдерская атака** - это намеренное нарушение правил сервера\
    \
    **Пример:** Намеренное убийство союзников

[^18]: **Ограничители пропускной способности** - программы, целью которых является ограничение входящего/исходящего интернет-трафика в игре для получения существенного преимущества над другими игроками

[^19]: 

    **Признаки адекватного приказа:**
...
[^20]: **TK** - Тим килл / Убийство союзника (Используется при выдачи блокировки за убийство союзников по правилу C5)
