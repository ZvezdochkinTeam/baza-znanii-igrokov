...
{% stepper %}
{% step %}
Откройте консоль (по умолчанию на клавишу <kbd>Ё</kbd>)
{% endstep %}
...
{% stepper %}
{% step %}
Откройте настройки и перейдите в категорию **"Server-Specific"**
{% endstep %}

{% step %}
Найдите категорию **"Расширенный голосовой чат"**
{% endstep %}

{% step %}
Нажмите на выпадающий список у настройки **"Шаблон озвучки голосовых реплик"**
{% endstep %}
{% endstepper %}
...
{% step %}
Переключите настройку **"Голосовые реплики"** на значение **"Отключить"**
{% endstep %}
{% endstepper %}
...
{% stepper %}
{% step %}
Открыть список игроков (по умолчанию на клавишу <kbd>N</kbd>)
{% endstep %}
...
1. Откройте консоль (по умолчанию на клавишу <kbd>Ё</kbd>)
2. Используйте команду `unbind (Название Клавиши)` или `unbind all` (для удаления всех биндов).&#x20;
{% endhint %}
